...
export default function DateRangePickerF({ date, setDate, className }) {
  ...
  function generateMonthDates(year, month) {
    ...
    // Add empty slots for the first week to align days
  ...
  function handleDateClick(day) {
    if (!date?.from && !date?.to) {
      ...
      if (day < date.from) {
        ...
        // Reset selection on click within the range
        setDate({ from: day, to: null });
      }
    }
  }

  function renderCalendar(year, month, isFirstCalendar) {
