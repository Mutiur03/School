                    ...
                    {editorTab === 'domains' && (
                      <div className="space-y-4">
                        <p className="text-muted-foreground text-xs">
                          ...
                          <code className="text-foreground">/result</code> when blank. Leave teacher
                          or student login blank to hide that link.
                        </p>
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                          ...
                          <div className="flex flex-wrap items-start justify-between gap-3">
                            <div className="space-y-1">
                              ...
                              <p className="text-muted-foreground max-w-xl text-xs leading-relaxed">
                                Landscape photos rotate behind the header logo on the public site.
                                Order here is the carousel order — drag a slide or use the arrows,
                                then save.
                              </p>
                            </div>
                            {bannerDisplayItems.length < 12 ? (
