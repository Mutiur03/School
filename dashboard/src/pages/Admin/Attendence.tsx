    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto space-y-8">
      ...
      {lastSaveResult && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatsCard
            label="SMS Success"
            value={lastSaveResult.sms.successful}
            color="blue"
          ...
          <StatsCard
            label="SMS Failed"
            value={lastSaveResult.sms.failed}
            color="amber"
            ...
            <div className="flex flex-nowrap overflow-x-auto gap-1.5 p-3 bg-muted/30 rounded-lg border border-border/50 scrollbar-thin scrollbar-thumb-primary/20 scrollbar-track-transparent">
              {Array.from({ length: daysInMonth }, (_, i) => i + 1).map((day) => (
                <button
                  ...
                  className={`flex-shrink-0 w-8 h-8 flex items-center justify-center text-xs font-medium rounded-md border transition-all ${
