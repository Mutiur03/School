              ...
              onChange: (e) => {
                if (!e.target.checked) {
                  ...
                  fields.forEach((field) =>
                    setValue(
                      field as any,
                      field === 'guardian_address_same_as_permanent' ? false : '',
                    ),
                  );
                }
              },
          ...
          <div className="space-y-2">
            ...
            >
              <select
                ...
                className="block w-full rounded border px-3 py-2 text-sm transition-[border-color,box-shadow] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-300 sm:text-base"
              >
