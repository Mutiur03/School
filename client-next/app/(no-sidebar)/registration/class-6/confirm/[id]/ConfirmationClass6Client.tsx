...
export default function ConfirmationClass6Client({
  registration,
  schoolConfig,
  pdfUrl,
}: ConfirmationClass6ClientProps) {
  ...
  const handleConfirmRegistration = async () => {
    ...
    try {
      setConfirming(true);
      const response = await axios.put(`/api/reg/class-6/form/${registration.id}/status`, {
        status: 'approved',
      });
    ...
    <div className="min-h-screen w-full bg-gray-100 px-4 py-8">
      <div className="mx-auto max-w-4xl">
        <div className="rounded-t bg-gray-800 p-6 text-white sm:p-8">
          <h1 className="text-2xl font-bold sm:text-3xl">Registration Confirmation</h1>
          ...
          {registration.status !== 'approved' ? (
            <div className="mb-6">
              ...
              <div className="flex flex-col justify-center gap-3 sm:flex-row">
                <Link
                  href={`/registration/class-6/form/${registration.id}`}
