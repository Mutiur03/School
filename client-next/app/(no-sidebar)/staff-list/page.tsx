...
async function page() {
  const staff = (await fetchStaffs()).sort(
    (a, b) => (Number(a.id) || 0) - (Number(b.id) || 0),
  );

  return (
    <div className="text-gray-800 p-4 sm:p-6 lg:p-8">
      <h1 className="text-2xl sm:text-3xl text-center font-serif mb-4 sm:mb-6">
        Staff List
      </h1>
            ...
            {staff.length === 0 ? (
              ...
              staff.map((member, index) => (
                <tr
                  ...
                  className={
                    index % 2 === 0
                      ? "bg-white divide-x divide-gray-200"
      ...
      <div className="lg:hidden">
        {staff.length === 0 ? (
          <div className="text-center py-8 text-gray-600">No staff found.</div>
        ) : (
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-4 space-y-4 sm:space-y-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        <span className="block text-xs font-medium text-gray-500 tracking-wider mb-1">
                          Email
                        </span>
