  ...
  return (
    <div className="py-8 sm:py-12">
      <div className="mx-auto max-w-6xl px-4">
        <h2 className="text-balance text-2xl sm:text-3xl md:text-4xl">At a glance</h2>

        <div className="mt-6 sm:mt-8">
          {allRows.length === 0 ? (
            <p className="text-sm text-gray-600">No school information available yet.</p>
          ) : (
            <div className="rounded-xs overflow-hidden bg-white shadow">
                ...
                {allRows.map((row, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <dd className="mt-1 min-w-0 break-words text-sm text-gray-700">
                  ...
                  {allRows.map((row, idx) => {
                    ...
                    return (
                      <tr key={row.label} className={isEven ? 'bg-gray-50' : 'bg-white'}>
                        ...
                        <td className="min-w-0 break-words border-b border-gray-300 px-4 py-4">
                          {renderCellValue(row.value)}
                        </td>
                      </tr>
                    );
