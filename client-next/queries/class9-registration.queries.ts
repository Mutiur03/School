...
export const getClass9RegistrationSettings = async (): Promise<Class9RegistrationSettings> => {
  try {
    const response = await api.get<Class9RegistrationSettings>('/api/reg/class-9');
