...
export const getClass6RegistrationSettings = async (): Promise<Class6RegistrationSettings> => {
  try {
    const response = await api.get<Class6RegistrationSettings>('/api/reg/class-6');
