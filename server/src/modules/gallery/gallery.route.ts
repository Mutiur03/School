...
// Admin moderation
router.get('/pending', AuthMiddleware.authenticate(['admin']), GalleryController.getPending);
router.get('/rejected', AuthMiddleware.authenticate(['admin']), GalleryController.getRejected);
router.patch('/approve/:id', AuthMiddleware.authenticate(['admin']), GalleryController.approve);
router.patch('/reject/:id', AuthMiddleware.authenticate(['admin']), GalleryController.reject);
router.post(
  '/rejectMultiple',
  AuthMiddleware.authenticate(['admin']),
...
router.post('/addCategory', AuthMiddleware.authenticate(['admin']), GalleryController.addCategory);
router.put(
