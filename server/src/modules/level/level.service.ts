...
export class LevelService {
  static async addLevel(data: LevelFormSchemaData) {
    ...
    await invalidateMarksheetsForLevel(result.class_name, result.section, result.year);
    return result;
  }
  ...
  static async updateLevel(id: number, data: LevelFormSchemaData) {
    ...
    if (
      ...
      await invalidateMarksheetsForLevel(data.class_name, data.section, data.year);
    }
