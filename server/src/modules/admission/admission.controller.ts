...
export class AdmissionController {
  static createOrUpdateAdmission = asyncHandler(async (req: Request, res: Response) => {
  ...
  static deleteAdmissionNotice = asyncHandler(async (_req: Request, res: Response) => {
  ...
  static getNoticeUploadUrl = asyncHandler(async (req: Request, res: Response) => {
