  ...
  static async createOrUpdateAdmission(data: AdmissionSettingsData) {
    ...
    const notice = await prisma.admission.upsert({
      ...
      create: {
        ...
        admission_year: (updateData.admission_year as number | null | undefined) ?? null,
        admission_open: (updateData.admission_open as boolean | null | undefined) ?? false,
        instruction: (updateData.instruction as string | null | undefined) ?? null,
        attachment_instruction_class6:
          (updateData.attachment_instruction_class6 as string | null | undefined) ?? null,
        attachment_instruction_class7:
          (updateData.attachment_instruction_class7 as string | null | undefined) ?? null,
        attachment_instruction_class8:
          (updateData.attachment_instruction_class8 as string | null | undefined) ?? null,
        attachment_instruction_class9:
          (updateData.attachment_instruction_class9 as string | null | undefined) ?? null,
        ingikar: (updateData.ingikar as string | null | undefined) ?? null,
        class_list: (updateData.class_list as string | null | undefined) ?? null,
        list_type_class6: (updateData.list_type_class6 as string | null | undefined) ?? null,
        list_type_class7: (updateData.list_type_class7 as string | null | undefined) ?? null,
        list_type_class8: (updateData.list_type_class8 as string | null | undefined) ?? null,
        list_type_class9: (updateData.list_type_class9 as string | null | undefined) ?? null,
        user_id_class6: (updateData.user_id_class6 as string | null | undefined) ?? null,
        user_id_class7: (updateData.user_id_class7 as string | null | undefined) ?? null,
        user_id_class8: (updateData.user_id_class8 as string | null | undefined) ?? null,
        user_id_class9: (updateData.user_id_class9 as string | null | undefined) ?? null,
        serial_no_class6: (updateData.serial_no_class6 as string | null | undefined) ?? null,
        serial_no_class7: (updateData.serial_no_class7 as string | null | undefined) ?? null,
        serial_no_class8: (updateData.serial_no_class8 as string | null | undefined) ?? null,
        serial_no_class9: (updateData.serial_no_class9 as string | null | undefined) ?? null,
      },
    });
