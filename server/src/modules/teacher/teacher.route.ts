...
router.delete(
  '/:id',
  AuthMiddleware.authenticate(['admin']),
  TeacherController.deleteTeacherController,
);
...
router.post(
  ...
  TeacherController.getTeacherImageUploadUrlController,
);
router.put(
  '/:id/image',
  AuthMiddleware.authenticate(['admin', 'teacher']),
  TeacherController.saveTeacherImageController,
);
router.delete(
  '/:id/image',
  AuthMiddleware.authenticate(['admin', 'teacher']),
  TeacherController.removeTeacherImageController,
);
...
router.post(
  ...
  AuthMiddleware.authenticate(['admin', 'teacher']),
  TeacherController.getTeacherSignatureUploadUrlController,
);
router.put(
  '/:id/signature',
  AuthMiddleware.authenticate(['admin', 'teacher']),
  TeacherController.saveTeacherSignatureController,
);
router.delete(
  '/:id/signature',
  AuthMiddleware.authenticate(['admin', 'teacher']),
  TeacherController.removeTeacherSignatureController,
);
...
router.post(
  ...
  TeacherController.changePasswordController,
);
router.post(
  '/password-rotations',
  AuthMiddleware.authenticate(['admin']),
  TeacherController.rotatePasswordsBulkController,
);
...
router.post(
  '/head-message',
  AuthMiddleware.authenticate(['admin']),
  TeacherController.updateHeadMessageController,
);
