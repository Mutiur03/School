...
docker exec -i prod-postgres_school-1 pg_restore -U mutiur -d school --data-only --disable-triggers < "/media/mutiur03/New Volume/Projects/volumes/school-backup.sql"
