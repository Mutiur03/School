  ...
  const fetchResult = async () => {
    ...
    try {
      ...
      const classResult = results.find(
        (r) =>
          r.class_name === classNumber && r.admission_year === admissionYear,
      );
      ...
      {!isLoading && !result && (
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-12 text-center">
          ...
          <p className="text-gray-500">
            Admission results for Class {classNumber} have not been published
            ...
            <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-5">
              ...
              <ul className="space-y-2 text-sm text-blue-900">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Download and check your roll number carefully in the PDF
                    file.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 font-bold mt-0.5">•</span>
                  <span>
                    If you are on the waiting list, you will be notified if a
