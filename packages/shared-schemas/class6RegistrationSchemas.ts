...
const registrationObjectShape = z
  .object({
    student_name_bn: z
      .string()
    ...
    permanent_post_office: z.string().min(1, "Post Office is required").default(""),
    permanent_post_code: z
      .string()
      .min(1, "Post Code is required")
      .regex(POST_CODE, "Must be 4 digits")
      .default(""),
    permanent_village_road: z.string().min(1, "Village/Road is required").default(""),
    ...
    present_post_code: z
      ...
      .regex(POST_CODE, "Must be 4 digits")
      .default(""),
    present_village_road: z.string().min(1, "Village/Road is required").default(""),
    ...
    prev_school_name: z.string().min(1, "Previous School Name is required").default(""),
